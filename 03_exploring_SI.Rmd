...
Interestingly, I find fewer unique files than reported (183 here vs. 190 reported), but substantially more variable contexts (13,506 here vs. 9,065 reported). If I only rely on the column labeled "Total.Variable.Contexts", I still arrive at a different value than the reported one (6,753 vs. 9,065).
